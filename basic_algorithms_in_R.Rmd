...
### L'algoritmo scorre tutto il vettore finché non vengono più eseguiti scambi, 
### situazione che indica che il vettore é ordinato. 
...
### numero centrale è maggiore di quello ricercato allora spostare la ricerca a sinistra 
### se il numero centrale è minore di quello ricercato spostare la ricerca a destra se le 
### posizioni finiscono e il vettore non è stato trovato indicare che non è stato trovato.
